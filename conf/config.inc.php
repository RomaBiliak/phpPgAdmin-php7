<?php
#
# УВАГА! Це тимчасовий файл, його редагування немає сенсу!
#
?>
<?php
/**
...
$conf['servers'][0]['pg_dump_path'] = 'd:\\ospanel\\modules\\database\\PostgreSQL-9.6-x64\\bin\\pg_dump.exe';
$conf['servers'][0]['pg_dumpall_path'] = 'd:\\ospanel\\modules\\database\\PostgreSQL-9.6-x64\\bin\\pg_dumpall.exe';
